...
CREATE TABLE IF NOT EXISTS ia_bienestar_alertas (
    ...
    codigo_plantilla VARCHAR(60) NOT NULL,
    tipo_alerta ENUM('RIESGO_BIENESTAR','CRISIS','ESCALAMIENTO_MANUAL') NOT NULL DEFAULT 'RIESGO_BIENESTAR',
...
(
  'BIENESTAR_GENERAL',
  'Bienestar general diario',
  'Chequeo breve para revisar estado emocional, energía, sueño, apoyo y ambiente.',
  'BIENESTAR_GENERAL',
  'ALUMNOS',
  '1-5',
  100.00,
  'Este espacio acompaña, no diagnostica y no reemplaza atención profesional.',
  'Actúa como un asistente de acompañamiento institucional, breve, cálido, motivador y práctico.',
  'ACTIVA',
  1
),
(
  ...
  'Evalúa concentración, organización, motivación y carga académica para prevenir saturación.',
  'ACOMPAÑAMIENTO_ACADEMICO',
  'ALUMNOS',
  '1-5',
  100.00,
  'Este espacio acompaña, no diagnostica y no reemplaza atención profesional.',
  'Actúa como un asistente de acompañamiento académico, práctico, claro y no clínico.',
  'ACTIVA',
  2
),
(
  'BIENESTAR_LABORAL',
  'Bienestar laboral',
  'Revisa carga laboral, límites de horario, pausas activas y clima de trabajo.',
  'BIENESTAR_LABORAL',
  'DOCENTES',
  '1-5',
  100.00,
  'Este espacio acompaña, no diagnostica y no reemplaza atención profesional.',
  'Actúa como un asistente de acompañamiento laboral, breve, claro y orientado a acciones pequeñas.',
  'ACTIVA',
  3
);
...
WHERE NOT EXISTS (
  SELECT 1
  FROM ia_bienestar_plantilla_preguntas ep
  WHERE ep.id_plantilla = p.id_plantilla
    AND ep.codigo_pregunta = q.codigo_pregunta
);
...
-- =========================================================
-- MIGRACIÓN: Columnas adicionales para tablas existentes
-- =========================================================
